...
def cek_opsi():
	...
	for kes in akun:
		try:
			...
			ua = 'Mozilla/5.0 (Linux; Android 10; RMX2189 Build/QP1A.190711.020; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/88.0.4324.181 Mobile Safari/537.36'
			ses = requests.Session()
